...
<div id="form-content">
    <form action="edit" method="post" enctype="multipart/form-data">
        ...
        <p class="lbl">From</p>
        <input type="text" name="txt-from" id="txt-from" value="<?php echo htmlspecialchars($get_recinfo['_from']); ?>" placeholder="Type here" required oninput="formatMultiplePhoneNumbers(this)" maxlength="32" />
        <p class="lbl">To</p>
