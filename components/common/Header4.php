    ...
    <div class="field is-flex pad has-bc">
        ...
        <div class="group is-flex">
            ...
            <div class="section-header">
                <h2 class="section-title">Fax To <?php display($get_recinfo['_from'])?></h2>
            </div>
        </div>
        <div class="group">
            <div class="section-header">
        ...
        <div class="group is-flex ">
            <div class="navs">
                <div class="item is-flex  has-curs">
                    <p class="lbl" onclick="router('edit-sent');"><?php display(formatDate($get_recinfo["createdAt"], "M jS")); ?></b>&nbsp; <?php display(formatDate($get_recinfo["createdAt"], "g:ia")); ?> PST</p>
                </div>
            </div>
            <div class="section-header spc-lft">
                <div class="line"></div>
